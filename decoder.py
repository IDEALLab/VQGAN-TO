...
class Decoder(nn.Module):
    def __init__(self, args):
        ...
        layers = [self._conv(args.spectral_decoder, args.latent_dim, in_channels, 3, 1, 1),
        ...
        layers.append(Swish())
        layers.append(self._conv(args.spectral_decoder, in_channels, args.image_channels, 3, 1, 1))
